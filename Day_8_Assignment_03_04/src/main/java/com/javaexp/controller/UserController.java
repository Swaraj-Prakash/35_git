...
public class UserController {
	...
	public User getUserById(@PathVariable Long id) {
		log.info("UserController :: getUserFindById {}",id);
	...
	public User fetchUserByUserNameOrEmail(@PathVariable String username,@PathVariable String email) {
		return userService.fetchUserByUsernameOrEmail(username, email);
	}
}
